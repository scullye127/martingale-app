...
import '/index.dart';
import 'admin_page_assigned_widget.dart' show AdminPageAssignedWidget;
import 'package:flutter/material.dart';

class AdminPageAssignedModel extends FlutterFlowModel<AdminPageAssignedWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in AdminPage-assigned widget.
