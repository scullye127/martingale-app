...
import 'admin_page_assigned_model.dart';
export 'admin_page_assigned_model.dart';

class AdminPageAssignedWidget extends StatefulWidget {
  ...
  State<AdminPageAssignedWidget> createState() =>
      _AdminPageAssignedWidgetState();
}

class _AdminPageAssignedWidgetState extends State<AdminPageAssignedWidget> {
  late AdminPageAssignedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdminPageAssignedModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'AdminPage-assigned'});
    // On page load action.
