...
import '/index.dart';
import 'admin_page_new_completed_widget.dart' show AdminPageNewCompletedWidget;
import 'package:flutter/material.dart';

class AdminPageNewCompletedModel
    extends FlutterFlowModel<AdminPageNewCompletedWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in AdminPage-newCompleted widget.
