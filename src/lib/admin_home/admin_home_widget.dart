...
class _AdminHomeWidgetState extends State<AdminHomeWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'adminHome'});
            ...
            children: [
              Align(
                ...
                child: Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('ADMIN_HOME_PAGE_tasks_ON_TAP');
                      logFirebaseEvent('tasks_navigate_to');
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('ADMIN_HOME_PAGE_boats_ON_TAP');
                      logFirebaseEvent('boats_navigate_to');

                      context.pushNamed(AdminBoatListWidget.routeName);
                    },
                    text: 'View Boats',
                    options: FFButtonOptions(
                      width: double.infinity,
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('ADMIN_HOME_PAGE_Logout_ON_TAP');
