...
import 'assign_contractor_widget.dart' show AssignContractorWidget;
import 'package:flutter/material.dart';

class AssignContractorModel extends FlutterFlowModel<AssignContractorWidget> {
  ...
  // Stores action output result for [Firestore Query - Query a collection] action in assignContractor widget.
